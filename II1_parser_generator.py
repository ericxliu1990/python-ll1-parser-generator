...
def main():
	...
	first_plus_set, production_map = a_set_table_generator.build_first_plus_set(first_set, follow_set)
	ll1_table = a_set_table_generator.build_ll1_table(first_plus_set, production_map)
